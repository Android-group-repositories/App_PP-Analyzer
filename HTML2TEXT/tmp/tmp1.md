...
Web-sites - web-sites with domain name “naxeex.com”  
  
We (Naxeex) \- Naxeex Ltd..  
...
Services \- software products developed by Naxeex Ltd., an updated list of which is located via the following link: Applications ; as well as websites with the domain name “naxeex.com”.  
...
---|---|---|---  
Game events |  We process your game events so that you can use all the functionality of the Services. |  Legal interest in providing services. |  Within 3 years from the last use of the Services.  
User data |  We process your user data so that you can use all the functionality of the Services.  |  Legal interest in providing services and improving the Services. |  Within 3 years from the last use of the Services.  
Information about errors |  We process your information about errors in order so that continuously improve our Services.  |  Legal interest in improving the Services.  |  Within 3 years from the last use of the Services.  
